...
//        assertThat(Files.toString(i18nFile, Charsets.US_ASCII)).isNotEqualTo(I18N);
        ...
        assertEquals(ASCII, Files.asCharSource(asciiFile, Charsets.US_ASCII).read());
        assertEquals(I18N, Files.asCharSource(i18nFile, Charsets.UTF_8).read());
        assertThat(Files.asCharSource(i18nFile, Charsets.US_ASCII).read()).isNotEqualTo(I18N);
    }
